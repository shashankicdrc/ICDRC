...
const Home3 = () => {
    return (
        <div className='bg-gradient-to-r from-orange-200 to-orange-400 px-4 md:px-8 py-6 my-4'>
            {/* Desktop View */}
            <h1 className='text-white  text-3xl md:text-6xl font-[Roboto] font-bold text-center px-8' data-aos="fade-up" data-aos-duration="1000">Are You Facing Any of These ?</h1>
                ...
                >
                    <SwiperSlide className='bg-white rounded-xl px-4 py-6'>
                        <div className='flex justify-around items-center'>
                            <h1 data-aos="zoom-in"
                                data-aos-duration="1000" className='text-gray-800 font-[Roboto] text-md font-semibold tracking-widest '>
