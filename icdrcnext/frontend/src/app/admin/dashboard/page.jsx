    ...
    return (
        <div className='bg-gradient-to-r from-orange-300 to-red-300 min-h-screen'>
            ...
            <div className='bg-white w-11/12 md:w-3/5 lg:w-2/5 border-2 border-gray-400 mx-auto my-8 px-3 py-2 rounded-xl'>
                ...
                <h2 className='mt-8 text-md font-semibold font-[Poppins]' data-aos="fade-up" data-aos-duration="2000">Name : <span className='text-orange-500 font-[Signika+Negative] ml-3 md:ml-8'>{admin?.name}</span></h2>
                <h2 className='mt-3 text-md font-semibold font-[Poppins]' data-aos="fade-up" data-aos-duration="2000">Email Id : <span className='text-orange-500 font-[Signika+Negative] ml-3 md:ml-8'>{admin?.emailId}</span></h2>
                <h2 className='mt-3 text-md font-semibold font-[Poppins]' data-aos="fade-up" data-aos-duration="2000">Current Position : <span className='text-orange-500 font-[Signika+Negative] ml-3 md:ml-8'>{admin?.role}</span></h2>
