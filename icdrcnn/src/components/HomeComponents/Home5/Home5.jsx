            ...
            <div className='bg-orange-200 py-4 md:py-8'>
                <div className='m-14 gap-12 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1'>
                    ...
                    <div className='border-2 bg-white border-gray-500 rounded-lg p-2 flex justify-center items-center flex-col'>
                        <img src="https://res.cloudinary.com/dl5hosmxb/image/upload/v1690785947/Home_page/Home5/1_fk5tn0.png" alt="" className='rounded-xl mb-2 md:mb-4 p-2' data-aos="fade-up" data-aos-duration="1000" />
                    ...
                    <div className='border-2 bg-white border-gray-500 rounded-lg p-2 flex justify-center items-center flex-col'>
                        <img src="https://res.cloudinary.com/dl5hosmxb/image/upload/v1690785947/Home_page/Home5/2_qdvpkx.png" alt="" className='rounded-xl mb-2 md:mb-4 p-2' data-aos="fade-up" data-aos-duration="1000" />
                        <h1 className='text-gray-900 text-xl md:text-2xl font-[Roboto] font-bold text-center bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent px-8' data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div className='border-2 bg-white border-gray-500 rounded-lg p-2 flex justify-center items-center flex-col'>
                        <img src="https://res.cloudinary.com/dl5hosmxb/image/upload/v1690785947/Home_page/Home5/3_ktfucm.png" alt="" className='rounded-xl mb-2 md:mb-4 p-2' data-aos="fade-up" data-aos-duration="1000" />
                        <h1 className='text-gray-900 text-xl md:text-2xl font-[Roboto] font-bold text-center bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent px-8' data-aos="fade-up" data-aos-duration="1000">
