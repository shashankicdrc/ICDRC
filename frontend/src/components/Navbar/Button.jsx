...
const Button = () => {
  return (
    <div className="flex flex-col gap-8 md:flex-row justify-center items-center">
      ...
      <Link to="/login" className="max-w-max rounded-md px-3.5 py-1 flex justify-center items-center m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-orange-500 text-indigo-600 hover:text-white">
        ...
        <span className="relative text-orange-500 transition duration-300 group-hover:text-white ease">Login</span>
      </Link>
    </div>
  );
};
