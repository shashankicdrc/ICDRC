            ...
            >
                ...
                <SwiperSlide className="testimonial-slide bg-white rounded-xl border-2 border-gray-800">
                    <div className="mb-4  p-4 md:mb-0">
                        ...
                        <h5 className="mb-2 text-lg font-bold text-orange-600 text-center">Sarah Johnson</h5>
                        ...
                        <p className="mb-4 text-center text-gray-900 font-[Roboto] text-semibold tracking-wide">
                            Choosing ICDRC was a game-changer for my insurance claim. Their professionalism, prompt updates, and relentless pursuit of my rightful compensation left me impressed and satisfied.
                ...
                <SwiperSlide className="testimonial-slide bg-white rounded-xl border-2 border-gray-800">
                    <div className="mb-4  p-4 md:mb-0">
                        ...
                        <h5 className="mb-2 text-lg font-bold text-orange-600 text-center">John Anderson</h5>
                        <h6 className="mb-4 font-medium text-primary text-orange-500 text-center">
                ...
                <SwiperSlide className="testimonial-slide bg-white rounded-xl border-2 border-gray-800">
                    <div className="mb-4  p-4 md:mb-0">
                        ...
                        <h5 className="mb-2 text-lg font-bold text-orange-600 text-center">Emily Carter</h5>
                        <h6 className="mb-4 font-medium text-primary text-orange-500 text-center">
                            Teacher
                        </h6>
                        <p className="mb-4 text-center text-gray-900 font-[Roboto] text-semibold tracking-wide">
