...
import Home7 from '../../../public/home7.png';
    ...
    return (
        <div className='my-2 md:pt-4 mb-8'>
            ...
            <div className='flex justify-center items-center md:items-start flex-col md:flex-row gap-4 px-4 md:pl-8 md:pr-20 py-4'>
                <Image src={Home7} alt="" className='w-4/5 md:w-2/5 bg-cover' data-aos="fade-up" data-aos-duration="1000" width={400} height={400} />
                ...
                <div>
                    ...
                    <div className='mt-4 md:mt-8 flex justify-between gap-4 flex-col md:flex-row' data-aos="fade-up" data-aos-duration="1000" >
                        <Link href='/register' className="b relative mx-auto h-16 w-64 flex justify-center items-center">
                        ...
                        <Link href='/partner' className="b animate-pulse mx-auto h-16 w-64 flex justify-center items-center">
