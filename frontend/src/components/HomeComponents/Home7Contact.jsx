        ...
        <Fragment>
            ...
            <div className="grid gap-5 grid-cols-1 lg:grid-cols-7 mx-5 lg:mx-10 items-center">
                ...
                <div className="px-4 py-3 lg:col-span-4 space-y-4 text-justify">
                    <p>
                        ICDRC, we're here to help you with insurance claims and
                        disputes. We're committed to protecting what matters
                        most to you and providing reliable insurance solutions
                        for a worry-free future.
                    </p>
                    <p>
                        We're your trusted partner for insurance claims and
                        dispute resolution! If you need expert guidance on
                        insurance claims or resolving disputes, partner with us
                        for a smooth experience. Our team of experienced
                        professionals is ready to support you at every step.
                    </p>
                    <p>
                        If you're facing an insurance dispute, register your
                        complaint with us now. Our skilled negotiators will work
                        to find a fair solution for you.
                    </p>
                    <p>
                        Choose ICDRC for transparent, understanding, and
                        effective insurance services. Click below to get
                        started!
                    </p>

                    <div
                        className="mt-4 lg:mt-8 flex flex-col lg:flex-row justify-between gap-4"
                        data-aos="fade-up"
                    ...
                    >
                        ...
                        <Link
                            href="/partner"
                            className="animate-pulse mx-auto h-16 w-64 flex justify-center items-center"
                        >
