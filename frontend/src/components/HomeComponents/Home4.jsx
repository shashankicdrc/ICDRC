            ...
            <div className="road-map-main">
              ...
              <div className="road-map-wrapper">
                <div className="road-map-circle">
                  <span className="road-map-circle-text flex items-center justify-center">
                    <Image
                      src="https://res.cloudinary.com/dl5hosmxb/image/upload/v1690785538/Home_page/Home4/2_g0mb93.svg"
                      alt=""
                      width={50}
                      height={50}
                    />
              ...
              <div className="road-map-wrapper">
                <div className="road-map-circle">
                  <span className="road-map-circle-text flex items-center justify-center">
                    <Image
                      src="https://res.cloudinary.com/dl5hosmxb/image/upload/v1690785538/Home_page/Home4/5_k7hv95.svg"
                      alt=""
                      width={50}
                      height={50}
                    />
