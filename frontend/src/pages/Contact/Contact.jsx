...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${url}/api/handlecontact`, {
                name, email, mobile, whatsapp, message
            })
            if (res?.data?.success) {
                setName('');
                setEmail('');
    ...
    return (
        <div className=''>
            ...
            <h1 className='text-gray-900 text-3xl mt-6 md:mt-8 md:text-6xl font-[Roboto] font-bold text-center bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent px-8' data-aos="fade-up" data-aos-duration="1000">CONTACT US NOW</h1>
                        ...
                        <div className="xl:w-10/12 xl:mx-auto px-4">
                            <div className="md:flex md:-mx-4 mt-4 md:mt-10">
                                ...
                                <div className="md:w-2/3 md:px-4">
                                    <form className="contact-form" onSubmit={handleSubmit} data-aos="fade-up" data-aos-duration="1000">
                                        <div className="sm:flex sm:flex-wrap -mx-3">
                                            ...
                                            <div className="sm:w-1/2 px-3 mb-6">
                                                <input type="email" placeholder="E-mail address" className="border-2 rounded px-3 py-1 w-full focus:border-orange-500 input"
                                                    value={email} onChange={(e) => setEmail(e.target.value)} required={true} />
                                            </div>

                                            <div className="sm:w-1/2 px-3 mb-6">
                                                <input type="mobile" name='mobile' id='mobile' placeholder="Whatspp number" className="border-2 rounded px-3 py-1 w-full focus:border-orange-500 input" minLength={10} maxLength={10}
                                                    value={whatsapp} onChange={(e) => setWhatsapp(e.target.value)} required={true} />
                                            </div>
                                            <div className="sm:w-full px-3">
                                                <textarea name="message" id="message" cols="30" rows="4" placeholder="Your message here" className="border-2 rounded px-3 py-1 w-full focus:border-orange-500 input" value={message} onChange={(e) => setMessage(e.target.value)} required={true}></textarea>
                                            </div>
                                        </div>
                                ...
                                <div className="md:w-1/3 md:px-4 mt-10 md:mt-0">
                                    <div className="bg-white border-2 border-orange-500 rounded-xl py-4 px-6" data-aos="fade-up" data-aos-duration="1000">
                                        <h5 className="text-xl text-orange-500 font-medium mb-3">HELP</h5>
                                        <p className="text-gray-700 mb-4">Need help or have any query? Don't hesitate, you can directly shoot us an <a href="mailto:" className="text-orange-500 border-b border-transparent hover:border-orange-500 inline-block font-semibold">email</a> or call us at <a href="tel:" className="text-orange-500 font-semibold border-b border-transparent hover:border-orange-500 inline-block">+91 92345XXXXX</a></p>
                                        <p className="text-gray-700">You can move to <a href="/" className="text-orange-500 border-b border-transparent font-semibold hover:border-orange-500 inline-block">FAQs</a> page to get more information about our site.</p>
                                    </div>
                                </div>
