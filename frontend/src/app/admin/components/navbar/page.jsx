    ...
    return (
        <nav className={`${navbar ? "bg-white" : ""} fixed w-full z-10 transition-all ease-in-out duration-75`}>
            <div className="flex items-center font-medium justify-around">
                ...
                <ul className="md:flex hidden items-center gap-8 font-[Signika+Negative] z-20">
                    ...
                    <li>
                        <Link href="/admin/dashboard/chatbotleads" className={`${navbar ? "text-gray-900" : "text-white"} py-7 px-3 inline-block font-semibold orange-link hover:text-orange-500`}>
                            Chatbot
                        </Link>
                    </li>
                    <li>
                        <Link href="/admin/dashboard/newsletter" className={`${navbar ? "text-gray-900" : "text-white"} py-7 px-3 inline-block font-semibold orange-link hover:text-orange-500`}>
                            Subscriptions
                        </Link>
                    </li>
                    <AdminNavLinks navbar={navbar} />
                    <li>
                        <Link href="/admin/dashboard/partnerdata" className={`${navbar ? "text-gray-900" : "text-white"} py-7 px-3 inline-block font-semibold orange-link hover:text-orange-500`}>
                            Partners
                        </Link>
                    </li>
                    <li>
                        <Link href="/admin/dashboard/contactmessages" className={`${navbar ? "text-gray-900" : "text-white"} py-7 px-3 inline-block font-semibold orange-link hover:text-orange-500`}>
                            Contacts
                        </Link>
                    </li>
                    <li>
        ...
        `}
                >
                    ...
                    <li>
                        <Link href="/admin/dashboard/chatbotleads" className="py-7 px-3 inline-block">
                            Chatbot
                        </Link>
                    </li>
                    <li>
                        <Link href="/admin/dashboard/newsletter" className="py-7 px-3 inline-block">
                            Subscriptions
                        </Link>
                    </li>
                    <AdminNavLinks />
                    <li>
                        <Link href="/admin/dashboard/partnerdata" className="py-7 px-3 inline-block">
                            Partners
                        </Link>
                    </li>
                    <li>
                        <Link href="/admin/dashboard/contactmessages" className="py-7 px-3 inline-block">
                            Contacts
                        </Link>
                    </li>
                    <div className="py-5">
