            ...
            {adminLinks.map((link) => (
                <div key={link.name} >
                    <div className="px-3 text-left md:cursor-pointer group normal-case">
                        <h1
                            className={` ${navbar ?"text-gray-900" : "text-white"} text-gray-900  py-7 flex justify-between items-center md:pr-0 pr-5 group hover:text-orange-500 font-semibold`}
                            onClick={() => {
                        ...
                        {link.submenu && (
                            <div>
                                <div className="absolute top-14 hidden group-hover:md:block hover:md:block">
                                    ...
                                    <div className="p-2 bg-gray-900 text-gray-100 rounded-xl">
                                    ...
                                    <div>
                                        {slinks.sublink.map((slink) => (
                                            <li className="py-3 pl-4" key={slink.name}>
                                                <Link href={slink.link} className="text-gray-900" >{slink.name}</Link>
                                            </li>
                                        ))}
                                    </div>
                                </div>
